...
cursor.execute("SELECT produtos.nome,produtos.preco,produtos.estoque,categorias.nome FROM produtos INNER JOIN categorias ON categorias.id = produtos.categoria_id")
